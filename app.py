...
def get_users():
  try:
    ...
    return make_response({'error': 'error getting users'}, 500)
...
def get_user(id):
  try:
    ...
    return make_response({'message': 'error getting user'}, 500)
...
def update_user(id):
  try:
    ...
    return make_response({'message': 'error updating user'}, 500)
